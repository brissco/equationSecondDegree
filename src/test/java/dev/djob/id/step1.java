...
public void l_équation_du_second_degré_avec_coefficients_a_b_c(Integer int1, Integer int2, Integer int3)  {
    ...
    driver.get("file:///C:\\Users/NTCHAMBA/Downloads/your-artifact-id/your-artifact-id/client/app.html");
}
@When("je résous l'équation")
public void je_résous_l_équation() {
    // Récupérer les éléments du formulaire
    WebElement number1Input = driver.findElement(By.id("n1"));
    WebElement number2Input = driver.findElement(By.id("n2"));
    WebElement number3Input = driver.findElement(By.id("n3"));
